...
const Signup = ({ toggleAuth }) => {
  ...
  const renderDocumentPreview = () => {
    if (previewUrl) {
      return (
        <div className="mt-4">
          <p className="text-sm font-medium text-gray-300 mb-2">Document Preview:</p>
  ...
  return (
    ...
    >
      <h2 className="text-2xl md:text-3xl font-bold text-center mb-2 text-blue-300">Create Account</h2>
      <p className="text-center text-gray-400 mb-6">Register to access secure voting</p>
