...
const AdminPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFAF6] text-[#5a6d5a] pt-20 font-sans">
      {/* Header */}
      <header className="bg-[#99BC85] shadow-2xl">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex items-center space-x-4">
              <div className="bg-[#E4EFE7] p-3 rounded-xl shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#5a6d5a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div>
                <h1 className="text-3xl font-bold text-[#3a4d3a]">
                  ZKVote Admin Portal
                </h1>
                <p className="text-sm text-[#E4EFE7]">Zero-Knowledge Voting Management</p>
              </div>
            </div>
            {account && (
              <div className="mt-4 md:mt-0 flex items-center space-x-3">
                <div className="relative">
                  <div className="h-3 w-3 rounded-full bg-green-500 animate-pulse absolute -right-1 -top-1 ring-2 ring-green-500 ring-opacity-50"></div>
                  <div className="bg-[#E4EFE7] rounded-full px-4 py-2 border border-[#99BC85] shadow-sm flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2 text-[#5a6d5a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0015.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 008 4.07M3 15.364c.64-1.319 1-2.8 1-4.364 0-1.457.39-2.823 1.07-4" />
                    </svg>
                    <span className="text-sm font-mono truncate max-w-xs text-[#3a4d3a]">
                      {account.slice(0, 6)}...{account.slice(-4)}
                    </span>
                  </div>
                </div>
          ...
          <div className="mt-4">
            <p className="text-xs font-mono text-[#E4EFE7] break-all">Contract: {contractAddress}</p>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Status Messages */}
        {error && (
          <div className="mb-6 bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-lg shadow-inner flex items-start animate-fade-in">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
            </svg>
            <p>{error}</p>
        ...
        {success && (
          <div className="mb-6 bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-lg shadow-inner flex items-start animate-fade-in">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <p>{success}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            {/* Register Voters Card */}
            <div className="bg-[#FAF1E6] rounded-xl shadow-2xl border border-[#E4EFE7] overflow-hidden transition-all hover:border-[#99BC85]">
              <div className="bg-[#99BC85] px-6 py-4 border-b border-[#E4EFE7]">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-bold flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#FAF1E6]" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M8 9a3 3 0 100-6 3 3 0 000 6zM8 11a6 6 0 016 6H2a6 6 0 016-6z" />
                    </svg>
                    <span className="text-[#FAF1E6]">
                      Register Voters
                    </span>
                  </h2>
                  <span className="text-xs font-semibold px-2 py-1 rounded-full bg-[#E4EFE7] text-[#5a6d5a]">
                    {commitments.length} {commitments.length === 1 ? 'Voter' : 'Voters'}
                  </span>
                </div>
              </div>
              <div className="p-6">
                <form onSubmit={registerVotersHandler}>
                  <div className="space-y-4">
                    {commitments.map((commitment, index) => (
                      <div key={index} className="relative p-4 bg-[#FDFAF6] rounded-lg border border-[#E4EFE7] group hover:border-[#99BC85] transition-colors">
                        <div className="flex justify-between items-center mb-3">
                          <h3 className="font-medium text-[#99BC85] flex items-center">
                            <span className="bg-[#99BC85] text-[#FAF1E6] text-xs font-bold px-2 py-1 rounded-full mr-2">
                              #{index + 1}
                            </span>
                            Voter Credentials
                          </h3>
                          {commitments.length > 1 && (
                            <button 
                              type="button" 
                              onClick={() => removeVoterField(index)}
                              className="text-red-500 hover:text-red-600 text-sm flex items-center p-1 rounded-full hover:bg-red-100 transition-colors"
                              title="Remove voter"
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                        ...
                        <div className="space-y-3">
                          <div>
                            <label className="block text-sm font-medium text-[#5a6d5a] mb-1">
                              Commitment (bytes32)
                            </label>
                            <input
                              type="text"
                              ...
                              onChange={(e) => handleCommitmentChange(index, e.target.value)}
                              placeholder="0x... or string"
                              className="w-full p-2 bg-[#FDFAF6] border border-[#E4EFE7] rounded focus:ring-2 focus:ring-[#99BC85] focus:border-[#99BC85] text-[#5a6d5a] placeholder-[#99BC85] transition-all"
                              required
                            />
                          </div>
                          <div className="grid grid-cols-2 gap-3">
                            <div>
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  min="1"
                                />
                                <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-[#99BC85]">
                                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                  </svg>
                                </div>
                  ...
                  <div className="flex justify-between items-center mt-6">
                    <button
                      type="button"
                      onClick={addVoterField}
                      className="text-[#99BC85] hover:text-[#7a9a6a] font-medium flex items-center px-4 py-2 rounded-lg hover:bg-[#E4EFE7] transition-colors border border-[#E4EFE7] hover:border-[#99BC85]"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd" />
                      </svg>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="bg-[#99BC85] hover:bg-[#7a9a6a] text-[#FAF1E6] font-medium py-3 px-6 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#99BC85] focus:ring-offset-2 focus:ring-offset-[#FAF1E6] shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center transition-all transform hover:scale-105"
                    >
                      {loading ? (
                        <>
                          <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <div className="bg-[#FAF1E6] rounded-xl shadow-2xl border border-[#E4EFE7] overflow-hidden transition-all hover:border-[#99BC85]">
              ...
              <div className="p-6">
                <form onSubmit={getVoterDetailsHandler}>
                  <div className="mb-4">
                    <label className="block text-sm font-medium text-[#5a6d5a] mb-2">
                      Voter Commitment (bytes32)
                    </label>
                    <div className="flex rounded-lg overflow-hidden shadow-sm">
                      <input
                        ...
                        onChange={(e) => setVoterCommitment(e.target.value)}
                        placeholder="0x... or string"
                        className="flex-grow p-3 bg-[#FDFAF6] border border-[#E4EFE7] focus:ring-2 focus:ring-[#99BC85] focus:border-[#99BC85] text-[#5a6d5a] placeholder-[#99BC85] transition-all"
                        required
                      />
                      <button
                        type="submit"
                        disabled={loading}
                        className="bg-[#99BC85] hover:bg-[#7a9a6a] text-[#FAF1E6] font-medium px-4 focus:outline-none focus:ring-2 focus:ring-[#99BC85] disabled:opacity-50 flex items-center transition-colors"
                      >
                        {loading ? (
                          <svg className="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                ...
                {voterDetails && (
                  <div className="mt-6 p-5 bg-[#FDFAF6] rounded-xl border border-[#E4EFE7]">
                    <h3 className="font-bold text-[#99BC85] mb-4 flex items-center text-lg">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v1h8v-1zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-1a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v1h-3zM4.75 12.094A5.973 5.973 0 004 15v1H1v-1a3 3 0 013.75-2.906z" />
                      </svg>
                      Voter Statistics
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="bg-[#E4EFE7] p-4 rounded-lg text-center border border-[#99BC85]">
                        <div className="text-xs font-medium text-[#5a6d5a] mb-1">Voting Power</div>
                        <div className="text-2xl font-bold text-[#3a4d3a]">{voterDetails.votingPower}</div>
                        <div className="text-xs text-[#99BC85] mt-1">Vote Weight</div>
                      </div>
                      <div className="bg-[#E4EFE7] p-4 rounded-lg text-center border border-[#99BC85]">
                        <div className="text-xs font-medium text-[#5a6d5a] mb-1">Dispute Credits</div>
                        <div className="text-2xl font-bold text-[#3a4d3a]">{voterDetails.disputeCredits}</div>
                        <div className="text-xs text-[#99BC85] mt-1">Available</div>
                      </div>
                      <div className="bg-[#E4EFE7] p-4 rounded-lg text-center border border-[#99BC85]">
                        <div className="text-xs font-medium text-[#5a6d5a] mb-1">Remaining</div>
                        <div className="text-2xl font-bold text-[#3a4d3a]">{voterDetails.remainingCredits}</div>
                        <div className="text-xs text-[#99BC85] mt-1">Credits Left</div>
                      </div>
                    </div>
                  </div>
                )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#FAF1E6] rounded-xl shadow-2xl border border-[#E4EFE7] overflow-hidden transition-all hover:border-[#99BC85]">
              ...
              <div className="p-6">
                ...
                {topicDetails && (
                  <div className="mt-6 bg-[#FDFAF6] rounded-xl border border-[#E4EFE7] overflow-hidden">
                    <div className="p-4 bg-[#E4EFE7] border-b border-[#99BC85]">
                      <h3 className="font-bold text-[#3a4d3a] flex items-center text-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#99BC85]" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                        </svg>
                        {topicDetails.name}
                      </h3>
                      <p className="text-sm text-[#5a6d5a] mt-1">
                    ...
                    <div className="p-5">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        <div className="space-y-1">
                          <div className="text-xs font-medium uppercase text-[#99BC85]">Voting Method</div>
                          <div className="font-medium text-[#5a6d5a]">{topicDetails.method}</div>
                        </div>
                        
                        <div className="space-y-1">
                          <div className="text-xs font-medium uppercase text-[#99BC85]">Location</div>
                          <div className="font-medium text-[#5a6d5a]">{topicDetails.location}</div>
                        </div>
                        
                        <div className="space-y-1">
                          <div className="text-xs font-medium uppercase text-[#99BC85]">Start Time</div>
                          <div className="font-medium text-[#5a6d5a]">{topicDetails.startTime}</div>
                        </div>
                        
                        <div className="space-y-1">
                          <div className="text-xs font-medium uppercase text-[#99BC85]">End Time</div>
                          <div className="font-medium text-[#5a6d5a]">{topicDetails.endTime}</div>
                        </div>
                        
                        <div className="space-y-1">
                          <div className="text-xs font-medium uppercase text-[#99BC85]">Min Voting Power</div>
                          <div className="font-medium text-[#5a6d5a]">{topicDetails.minVotingPower}</div>
                        </div>
                        
                        <div className="space-y-1">
                          <div className="text-xs font-medium uppercase text-[#99BC85]">Voting Status</div>
                      ...
                      <div className="mt-6">
                        <h4 className="text-sm font-bold text-[#5a6d5a] mb-3 flex items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-[#99BC85]" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div className="space-y-3">
                          {topicDetails.choices.map((choice, idx) => (
                            <div key={idx} className="bg-[#E4EFE7] p-3 rounded-lg border border-[#99BC85]">
                              <div className="flex justify-between items-center mb-1">
                                <span className="font-medium text-[#3a4d3a]">{choice}</span>
                                <span className="text-sm font-bold text-[#99BC85]">
                                  {topicDetails.voteCounts[idx]} vote{parseInt(topicDetails.voteCounts[idx]) !== 1 ? 's' : ''}
                                </span>
                              </div>
                              <div className="w-full bg-[#FAF1E6] rounded-full h-2.5">
                                <div 
                                  className="bg-[#99BC85] h-2.5 rounded-full" 
                                  style={{ 
                                    width: `${Math.max(
                                      5,
                                      topicDetails.voteCounts.reduce((a, b) => a + parseInt(b), 0) === 0
                                        ? 0
                                        : (parseInt(topicDetails.voteCounts[idx]) / topicDetails.voteCounts.reduce((a, b) => a + parseInt(b), 0)) * 100
                                    )}%` 
                                  }}
                                ></div>
                              </div>
            ...
            <div className="bg-[#FAF1E6] rounded-xl shadow-2xl border border-[#E4EFE7] overflow-hidden transition-all hover:border-[#99BC85]">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-[#FDFAF6] rounded-lg border border-[#E4EFE7] shadow-sm hover:shadow-md hover:border-[#99BC85] transition-all cursor-pointer">
                  <div className="flex items-center">
                    <div className="bg-[#99BC85] p-3 rounded-full">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#FAF1E6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                      </svg>
                    </div>
                    <div className="ml-4">
                      <h3 className="text-md font-bold text-[#3a4d3a]">Create New Topic</h3>
                      <p className="text-xs text-[#5a6d5a]">Start a new voting topic</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-[#FDFAF6] rounded-lg border border-[#E4EFE7] shadow-sm hover:shadow-md hover:border-[#99BC85] transition-all cursor-pointer">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h3 className="text-md font-bold text-[#3a4d3a]">Manage Schedules</h3>
                      <p className="text-xs text-[#5a6d5a]">View & adjust voting periods</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-[#FDFAF6] rounded-lg border border-[#E4EFE7] shadow-sm hover:shadow-md hover:border-[#99BC85] transition-all cursor-pointer">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h3 className="text-md font-bold text-[#3a4d3a]">Generate Reports</h3>
                      <p className="text-xs text-[#5a6d5a]">Export voting results</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-[#FDFAF6] rounded-lg border border-[#E4EFE7] shadow-sm hover:shadow-md hover:border-[#99BC85] transition-all cursor-pointer">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h3 className="text-md font-bold text-[#3a4d3a]">System Settings</h3>
                      <p className="text-xs text-[#5a6d5a]">Configure platform options</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Footer */}
      <footer className="bg-[#99BC85] text-[#E4EFE7] mt-10">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-sm">© 2025 ZKVote - Zero Knowledge Voting System</p>
              <p className="text-xs mt-1">Secure, Private, Verifiable Elections</p>
            </div>
            <div className="flex space-x-4">
              <a href="#" className="text-[#E4EFE7] hover:text-white transition-colors">
