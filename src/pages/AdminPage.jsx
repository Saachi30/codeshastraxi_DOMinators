...
//                       className="text-blue-400 hover:text-blue-300 font-medium flex items-center px-4 py-2 rounded-lg hover:bg-blue-900/20 transition-colors border border-blue-900/50"
//                     >
...
//                       type="submit"
//                       disabled={loading}
//                       className="relative bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-medium py-3 px-6 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center overflow-hidden group"
//                     >
//                       <span className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-400 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
//                       {loading ? (
//                         <>
...
//               <div className="bg-gradient-to-r from-purple-900/70 to-indigo-800/70 px-6 py-4 border-b border-purple-500/20">
...
//                         className="flex-grow p-3 bg-gray-700/50 border border-gray-600/50 rounded-l-lg focus:ring-2 focus:ring-purple-500/70 focus:border-purple-500 text-gray-100 placeholder-gray-400 transition-all"
//                         required
//                       />
//                       <button
//                         type="submit"
//                         disabled={loading}
//                         className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-medium px-4 rounded-r-lg focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:opacity-50 flex items-center transition-colors"
//                       >
//                         {loading ? (
...
//                 {voterDetails && (
//                   <div className="mt-6 p-5 bg-gray-700/30 rounded-xl border border-gray-600/50">
...
//                       <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/40 p-4 rounded-lg border border-blue-700/30 text-center shadow-inner">
//                         <div className="text-xs font-semibold text-blue-300 uppercase tracking-wider mb-1">Voting Power</div>
...
//                             style={{ width: `${Math.min(100, (voterDetails.votingPower / 10) * 100)}%` }}
//                           ></div>
//                         </div>
//                       </div>
//                       <div className="bg-gradient-to-br from-purple-900/40 to-purple-800/40 p-4 rounded-lg border border-purple-700/30 text-center shadow-inner">
//                         <div className="text-xs font-semibold text-purple-300 uppercase tracking-wider mb-1">Dispute Credits</div>
...
//                             style={{ width: `${Math.min(100, (voterDetails.disputeCredits / 5) * 100)}%` }}
//                           ></div>
//                         </div>
//                       </div>
//                       <div className="bg-gradient-to-br from-green-900/40 to-green-800/40 p-4 rounded-lg border border-green-700/30 text-center shadow-inner">
//                         <div className="text-xs font-semibold text-green-300 uppercase tracking-wider mb-1">Remaining Credits</div>
...
//                             style={{ width: `${Math.min(100, (voterDetails.remainingCredits / 5) * 100)}%` }}
//                           ></div>
//                         </div>
//                       </div>
//                     </div>
...
//               <div className="bg-gradient-to-r from-cyan-900/70 to-teal-800/70 px-6 py-4 border-b border-cyan-500/20">
//                 <h2 className="text-xl font-bold flex items-center">
...
//                         placeholder="1"
//                         className="flex-grow p-3 bg-gray-700/50 border border-gray-600/50 rounded-l-lg focus:ring-2 focus:ring-cyan-500/70 focus:border-cyan-500 text-gray-100 placeholder-gray-400 transition-all"
//                         required
//                         min="1"
//                       />
//                       <button
//                         type="submit"
//                         disabled={loading}
//                         className="bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-500 hover:to-teal-500 text-white font-medium px-4 rounded-r-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 disabled:opacity-50 flex items-center transition-colors"
//                       >
//                         {loading ? (
//                           <svg className="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
//                             <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
...
//                 {topicDetails && (
//                   <div className="mt-6 p-5 bg-gray-700/30 rounded-xl border border-gray-600/50">
//                     <div className="flex justify-between items-start mb-5 pb-4 border-b border-gray-600/50">
//                       <div>
...
//                       }`}>
//                         {topicDetails.isVotingOpen ? 'VOTING ACTIVE' : 'VOTING CLOSED'}
//                       </span>
//                     </div>
                    
//                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
//                       <div className="bg-gray-700/40 p-4 rounded-lg border border-gray-600/30">
...
//                             <span className="text-gray-200">{topicDetails.startTime}</span>
//                           </div>
//                           <div className="flex items-center text-sm">
//                             <span className="text-gray-400 w-16">End:</span>
//                             <span className="text-gray-200">{topicDetails.endTime}</span>
//                           </div>
//                         </div>
//                       </div>
...
//                           <span className="text-sm text-gray-400 mr-2">Min Power:</span>
//                           <span className="text-cyan-300 font-medium">{topicDetails.minVotingPower}</span>
//                         </div>
//                       </div>
//                     </div>
...
//                         <input
//                           type="text"
//                           value={topicDetails.location}
//                           readOnly
//                           className="w-full pl-10 pr-3 py-2 bg-gray-800/50 border border-gray-700/50 rounded text-sm font-mono text-gray-300"
//                         />
//                       </div>
//                     </div>
...
//                           const voteCount = parseInt(topicDetails.voteCounts[idx]);
//                           const maxVotes = Math.max(...topicDetails.voteCounts.map(v => parseInt(v)));
//                           const percentage = maxVotes > 0 ? (voteCount / maxVotes) * 100 : 0;
                          
//                           return (
//                             <div key={idx} className="flex items-center">
//                               <div className="w-2/5 text-sm text-gray-300 truncate pr-2">{choice}</div>
//                               <div className="w-3/5 flex items-center">
//                                 <div className="flex-grow bg-gray-700 rounded-full h-2.5 mr-3 overflow-hidden">
//                                   <div 
//                                     className="h-full bg-gradient-to-r from-cyan-500 to-teal-500 rounded-full" 
//                                     style={{ width: `${percentage}%` }}
//                                   ></div>
//                                 </div>
//                                 <span className="text-xs font-bold text-cyan-300 w-8 text-right">{voteCount}</span>
//                               </div>
//                             </div>
//                           );
//                         })}
...
//             {/* Dashboard Info Card */}
//             <div className="bg-gray-800/80 rounded-xl shadow-2xl border border-gray-700/50 backdrop-blur-sm overflow-hidden">
//               <div className="bg-gradient-to-r from-gray-800/70 to-gray-900/70 px-6 py-4 border-b border-gray-600/20">
//                 <h2 className="text-xl font-bold flex items-center">
...
//                   </svg>
//                   <span className="bg-clip-text text-transparent bg-gradient-to-r from-gray-300 to-gray-200">
...
//                     Welcome to the ZKVote Admin Portal. This dashboard provides tools to manage zero-knowledge voting processes, 
//                     register voters, and monitor voting topics with complete transparency and security.
//                   </p>
                  
//                   <div className="bg-gray-700/40 p-5 rounded-xl border border-gray-600/30">
...
//                       </div>
//                     ) : (
//                       <div className="flex items-center p-3 bg-red-900/20 rounded border border-red-800/50">
//                         <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-red-400" viewBox="0 0 20 20" fill="currentColor">
//                           <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
//                         </svg>
//                         <span className="text-red-400">No Ethereum wallet connected. Please install MetaMask or another Web3 provider.</span>
//                       </div>
//                     )}
//                   </div>

//                   <div className="grid grid-cols-2 gap-3">
//                     <div className="bg-gray-700/40 p-4 rounded-lg border border-gray-600/30 text-center">
//                       <div className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Contract Status</div>
...
//                     </div>
//                     <div className="bg-gray-700/40 p-4 rounded-lg border border-gray-600/30 text-center">
//                       <div className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Network</div>
//                       <div className="text-blue-400 font-medium">Ethereum Mainnet</div>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//       {/* Footer */}
//       <footer className="mt-12 py-6 border-t border-gray-800/50">
//         <div className="container mx-auto px-4 text-center text-gray-500 text-sm">
//           <p>ZKVote Admin Dashboard v1.0.0 - Powered by Ethereum & Zero-Knowledge Proofs</p>
//           <p className="mt-1">© {new Date().getFullYear()} ZKVote Protocol. All rights reserved.</p>
//         </div>
//       </footer>
//     </div>
//   );
